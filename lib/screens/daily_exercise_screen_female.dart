...
class DailyExerciseFemale extends StatefulWidget {
  const DailyExerciseFemale({super.key});

  @override
  State<DailyExerciseFemale> createState() => _DailyExerciseFemaleState();
}

class _DailyExerciseFemaleState extends State<DailyExerciseFemale> {
