...
class FullBodyWorkoutMaleDetail extends StatefulWidget {
  final String title;
  ...
  final String des2;
  final String des3;
  const FullBodyWorkoutMaleDetail(
      {super.key,
      required this.title,
  ...
  @override
  State<FullBodyWorkoutMaleDetail> createState() =>
      _FullBodyWorkoutMaleDetailState();
}

class _FullBodyWorkoutMaleDetailState extends State<FullBodyWorkoutMaleDetail> {
  int currentIndex = 0;
