...
class FullBodyWorkoutFemaleDetail extends StatefulWidget {
  final String title;
  ...
  final String des2;
  final String des3;
  const FullBodyWorkoutFemaleDetail(
      {super.key,
      required this.title,
  ...
  @override
  State<FullBodyWorkoutFemaleDetail> createState() =>
      _FullBodyWorkoutFemaleDetailState();
}

class _FullBodyWorkoutFemaleDetailState
    extends State<FullBodyWorkoutFemaleDetail> {
  int currentIndex = 0;
