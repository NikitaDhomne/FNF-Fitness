...
class TenMinustesExercise extends StatefulWidget {
  final String title;
  ...
  @override
  State<TenMinustesExercise> createState() => _TenMinustesExerciseState();
}

class _TenMinustesExerciseState extends State<TenMinustesExercise> {
  int currentIndex = 0;
