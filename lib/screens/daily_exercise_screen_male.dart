...
class DailyExerciseMale extends StatefulWidget {
  const DailyExerciseMale({super.key});

  @override
  State<DailyExerciseMale> createState() => _DailyExerciseMaleState();
}

class _DailyExerciseMaleState extends State<DailyExerciseMale> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Daily Exercise Male"),
        centerTitle: true,
      ),
      body: Center(
