...
class DailyExerciseMaleDetail extends StatefulWidget {
  final String title;
  ...
  @override
  State<DailyExerciseMaleDetail> createState() =>
      _DailyExerciseMaleDetailState();
}

class _DailyExerciseMaleDetailState extends State<DailyExerciseMaleDetail> {
  int currentIndex = 0;
